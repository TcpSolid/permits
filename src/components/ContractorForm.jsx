...
import { X, Save, User, Phone, Mail, ClipboardList, FileText, Play } from 'lucide-react';
import { Button } from './ui/Button';

export const ContractorForm = ({ contractor, onSave, onCancel }) => {
        ...
        <div className="px-8 py-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              <div>
                <label className={labelClasses}>Contractor Name</label>
              ...
              <div>
                <label className={labelClasses}>Invoice / Accounts Payable Email</label>
                <div className="relative">
                  <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" size={18} />
                  <input
                    type="email"
              ...
              <div>
                ...
                <div className="relative">
                  <Play className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 rotate-90" size={18} />
                  <input
                    type="url"
                    name="website"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="Certifications, specialties, license numbers..."
