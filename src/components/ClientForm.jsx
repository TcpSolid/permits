        ...
        <div className="px-8 py-6 max-h-[85vh] overflow-y-auto custom-scrollbar">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              <div>
                <label className={labelClasses}>Client / Customer Name</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className={labelClasses}>Client Category</label>
                  <div className="relative">
              ...
              <div>
                <label className={labelClasses}>Billing / Project Address</label>
                <div className="relative">
              ...
              <div>
                <label className={labelClasses}>Additional Client Notes</label>
                <div className="relative">
            ...
            <div className="flex gap-4 pt-6 border-t border-slate-100 dark:border-white/5">
              <Button type="submit" className="flex-1 h-12 gap-2 text-base shadow-lg shadow-primary-500/20">
                <Save size={20} />
                {client ? 'Save Updates' : 'Register Client'}
              </Button>
